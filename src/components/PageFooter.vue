<template>
    <footer class="mt-3 bg-blue-200 dark:bg-gray-800 w-full py-8">
        <div class="max-w-screen-xl mx-auto px-4">
            <ul class="hidden max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
                <li class="my-2">
            ...
            <div class="pt-8 flex max-w-xs mx-auto items-center justify-around">
                <a href="#"
                    class="hidden text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
